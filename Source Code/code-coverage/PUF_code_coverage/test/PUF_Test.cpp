...
TEST_F(PUFTest, encrypt_test) {
    uint8_t result[32];
    uint8_t final_key[32] = {0xAE, 0x68, 0x52, 0xF8, 0x12, 0x10, 0x67, 0xCC,
                             0x4B, 0xF7, 0xA5, 0x76, 0x55, 0x77, 0xF3, 0x9E,
                             0xAE, 0x68, 0x52, 0xF8, 0x12, 0x10, 0x67, 0xCC,
                             0x4B, 0xF7, 0xA5, 0x76, 0x55, 0x77, 0xF3, 0x9E};
    uint8_t plain[32] = {0x53, 0x69, 0x6E, 0x67, 0x6C, 0x65, 0x20, 0x62,
                                  0x6C, 0x6F, 0x63, 0x6B, 0x20, 0x6D, 0x73, 0x67,
                                  0x53, 0x69, 0x6E, 0x67, 0x6C, 0x65, 0x20, 0x62,
                                  0x6C, 0x6F, 0x63, 0x6B, 0x20, 0x6D, 0x73, 0x67};
    uint8_t result_default[32] = {0x9e, 0x5d, 0x63, 0x1e, 0x00, 0x23, 0x7c, 0xda,
                          0x74, 0x07, 0x67, 0xbc, 0x53, 0x5f, 0x45, 0x84,
                          0x66, 0xf9, 0xe5, 0xd1, 0x91, 0xfd, 0xa2, 0xf3,
                          0x9a, 0x42, 0x62, 0x7d, 0x91, 0x30, 0xab, 0x40};
    ...
    puf.encrypt_test(final_key, iv, plain, result);
...
TEST_F(PUFTest, decrypt_test) {
    uint8_t final_key[32] = {0xAE, 0x68, 0x52, 0xF8, 0x12, 0x10, 0x67, 0xCC,
                             ...
                             0xAE, 0x68, 0x52, 0xF8, 0x12, 0x10, 0x67, 0xCC,
                             0x4B, 0xF7, 0xA5, 0x76, 0x55, 0x77, 0xF3, 0x9E};
    uint8_t result_default[32] = {0x53, 0x69, 0x6E, 0x67, 0x6C, 0x65, 0x20, 0x62,
                                  0x6C, 0x6F, 0x63, 0x6B, 0x20, 0x6D, 0x73, 0x67,
                                  0x53, 0x69, 0x6E, 0x67, 0x6C, 0x65, 0x20, 0x62,
                                  0x6C, 0x6F, 0x63, 0x6B, 0x20, 0x6D, 0x73, 0x67};
    uint8_t cypher[32] = {0x9e, 0x5d, 0x63, 0x1e, 0x00, 0x23, 0x7c, 0xda,
                          0x74, 0x07, 0x67, 0xbc, 0x53, 0x5f, 0x45, 0x84,
                          0x66, 0xf9, 0xe5, 0xd1, 0x91, 0xfd, 0xa2, 0xf3,
                          0x9a, 0x42, 0x62, 0x7d, 0x91, 0x30, 0xab, 0x40};
    uint8_t iv[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    puf.decrypt_test(final_key, iv, cypher, result);
