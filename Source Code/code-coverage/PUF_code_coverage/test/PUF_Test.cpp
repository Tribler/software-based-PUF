...
TEST_F(PUFTest, encrypt_test) {
    uint8_t final_key[32] = {0x08, 0x45, 0x36, 0xFC, 0xB3, 0x13, 0x5A, 0xF8, 0x9E, 0x1E, 0x32, 0xD4, 0x23, 0x15, 0x65,
                             0x11, 0xF1, 0x3E, 0x52, 0x24, 0x6A, 0xCA, 0xA5, 0x91, 0xB1, 0xD4, 0x11, 0x56, 0x66, 0x72,
                             0x78, 0x14};
    uint8_t plain[32] = {0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
                         0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72,
                         0x64};
    uint8_t result_default[32] = {0xFA, 0x65, 0x6B, 0x26, 0x90, 0xEA, 0x04, 0x8A, 0xE8, 0x07, 0xE2, 0x1F, 0xEF, 0xD1,
                                0xC4, 0xCA, 0xFA, 0x65, 0x6B, 0x26, 0x90, 0xEA, 0x04, 0x8A, 0xE8, 0x07, 0xE2, 0x1F,
                                0xEF, 0xD1, 0xC4, 0xCA};
    uint8_t result[32];
    memset(result, 0, sizeof(result));

    ASSERT_EQ(sizeof(result) , 32);
    ASSERT_EQ(sizeof(result_default) , 32);
    ASSERT_EQ(sizeof(final_key) , 32);
    ASSERT_EQ(sizeof(plain) , 32);
...
TEST_F(PUFTest, decrypt_test) {
    uint8_t final_key[32] = {0x08, 0x45, 0x36, 0xFC, 0xB3, 0x13, 0x5A, 0xF8, 0x9E, 0x1E, 0x32, 0xD4, 0x23, 0x15, 0x65,
                             0x11, 0xF1, 0x3E, 0x52, 0x24, 0x6A, 0xCA, 0xA5, 0x91, 0xB1, 0xD4, 0x11, 0x56, 0x66, 0x72,
                             0x78, 0x14};
    uint8_t result_default[32] = {0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f,
                                  0x72, 0x64, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x70, 0x61, 0x73, 0x73,
                                  0x77, 0x6f, 0x72, 0x64};
    uint8_t cypher[32] = {0xFA, 0x65, 0x6B, 0x26, 0x90, 0xEA, 0x04, 0x8A, 0xE8, 0x07, 0xE2, 0x1F, 0xEF, 0xD1,
                          0xC4, 0xCA, 0xFA, 0x65, 0x6B, 0x26, 0x90, 0xEA, 0x04, 0x8A, 0xE8, 0x07, 0xE2, 0x1F,
                          0xEF, 0xD1, 0xC4, 0xCA};
    uint8_t result[32];
    memset(result, 0, sizeof(result));
